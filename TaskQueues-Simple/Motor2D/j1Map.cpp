...
void j1Map::CalculateTilesInView()
{
	...
	SDL_Rect viewport = { -App->render->camera.x - data.tile_width, -App->render->camera.y - data.tile_height, App->render->camera.w + data.tile_width * 2, App->render->camera.h + data.tile_height * 1 };
